...
#define DASH_LENGTH 2           //2 times longer than dot
...
>>>>>>> d3241ae6c235c6de7d93227a73eec1dff3502757
  };
  ...
  // draw the given dotted side
  void DrawDottedSide (mozilla::css::Side aSide);
